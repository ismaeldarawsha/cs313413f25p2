...
public class TestList {
    ...
    public void setUp() throws Exception {
        ...
        // TODO Question (for README):
        // Also try with a LinkedList - does it make any difference?
        // Answer: No behavioral difference. Both work the same for correctness tests.
        // The only difference is in performance (ArrayList vs LinkedList).
    }
    ...
    public void testAddMultiple2() {
        ...
        // ✅ safer for JDK < 9 (replace List.of with Arrays.asList)
    ...
    public void testRemoveObject() {
        ...
        list.remove(Integer.valueOf(5)); // removes the element "5" itself
